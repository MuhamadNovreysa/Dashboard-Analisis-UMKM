            ...
            <Card key={segment.name} className="p-5 border-2">
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-semibold">Rp {(segment.avgValue / 1000).toFixed(0)}K</p>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-semibold">
                    Rp {((segment.avgValue * segment.count) / 1000000).toFixed(1)}M
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-border pt-4">
                ...
                {(() => {
                  ...
                  console.log("[v0] Segment card recommendations:", { segment: segment.name, recs })
                  return (
                    <ul className="space-y-1.5 mb-4">
                      {recs.map((rec: any, idx: number) => (
                        <li key={rec.id || idx} className="text-sm flex items-start gap-2">
            ...
            <div className="space-y-6 mt-4">
              <div className="grid grid-cols-4 gap-4">
                ...
                <Card className="p-4">
                  ...
                  <p className="text-2xl font-bold">
                    Rp {((selectedSegment.avgValue * selectedSegment.count) / 1000000).toFixed(1)}M
                  </p>
                </Card>
                <Card className="p-4">
                  <div className="flex items-center gap-2 text-muted-foreground mb-1">
                ...
                <Card className="p-4">
                  ...
                  <p className="text-2xl font-bold">Rp {(selectedSegment.avgValue / 1000).toFixed(0)}K</p>
                </Card>
              </div>
              ...
              <Card className="p-4 bg-primary/5">
                ...
                <ul className="space-y-2">
                  {getDynamicRecommendations(selectedSegment, data.segments).map((rec: any, idx: number) => (
                    <li key={rec.id} className="flex items-start gap-3">
                      <Badge variant="default" className="mt-0.5">
                        {idx + 1}
                      </Badge>
                      <div className="flex-1">
                        <p className="text-sm font-medium">{rec.nama}</p>
                        <p className="text-xs text-muted-foreground mt-1">
                          Score: {(rec.skor * 100).toFixed(0)}% | Matches: {rec.match} kondisi
                        </p>
                      </div>
                    </li>
                  ))}
